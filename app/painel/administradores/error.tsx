...
export default function ErroDosAdministradores({
  error,
  retry,
}: {
  ...
  return (
    <>
      <Cabecalho
        titulo="Administradores indisponível"
        descricao="Não foi possível ler quem alcança o painel agora."
      />
      <Conteudo>
        <section className="painel-cartao px-5 py-10 text-center">
          <h2 className="text-[1rem] font-semibold text-[var(--p-texto)]">
            A leitura dos administradores falhou
          </h2>
