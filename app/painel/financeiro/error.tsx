...
export default function ErroDoFinanceiro({
  error,
  retry,
}: {
  ...
  useEffect(() => {
    console.error("Falha ao carregar o financeiro no painel", error);
  }, [error]);
