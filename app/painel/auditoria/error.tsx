...
export default function ErroDaAuditoria({
  error,
  retry,
}: {
  ...
  return (
    <>
      <Cabecalho
        titulo="Auditoria indisponível"
        descricao="Não foi possível ler a trilha de ações administrativas agora."
      />
      <Conteudo>
        <section className="painel-cartao px-5 py-10 text-center">
          <h2 className="text-[1rem] font-semibold text-[var(--p-texto)]">
            A leitura da auditoria falhou
          </h2>
